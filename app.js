...
async function main() {
    const UUID = await getVariableValue('UUID', 'ccbfa010-f92b-49cf-8b4b-ae94b0fac112');
    console.log('你的UUID:', UUID);

    const PORT = await getVariableValue('PORT', '54321');
    console.log('你的端口:', PORT);

    const DOMAIN = await getVariableValue('DOMAIN', '9527.9528');
